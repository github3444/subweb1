#全局变量定义
subip = 'https://dy.wateraini.top'      # 默认subip是 subconverter 后台端口，在config/perf.ini 中指定，或者docker的端口指定。
apiip = 'https://api.wateraini.top'      #apiip 是 suweb 前端端口
passwd = '1433223a'                      #passwd 是 admin系统的密码
