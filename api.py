        ...
        if request.method == "POST":
            ...
            if '://' in s:
                ...
                if tool == 'sssubnode':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=sssub&url={sub}&list=true&include={custom}&exclude={custom2}&emoji={emoji}&fdn={fdn}'.format(custom2=encodeexcustom,sub=str(sub),custom=encodecustom,emoji=emoji,fdn=fdn)
                        return render_template('othernode.html',sub = s,custom=yourcustom,api=CustomGroupvmess,api2=api2)  
                if tool == 'v2raynode':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=v2ray&url={sub}&list=true&include={custom}&exclude={custom2}&emoji={emoji}&fdn={fdn}'.format(custom2=encodeexcustom,sub=str(sub),custom=encodecustom,emoji=emoji,fdn=fdn)
                        return render_template('othernode.html',sub = s,custom=yourcustom,api=CustomGroupvmess,api2=api2)                  
                else:
                    return render_template('basic.html')    
            else:
